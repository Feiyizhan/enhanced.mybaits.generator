 ...
 */
public enum ApiServiceMethodEnum {
    ...
    private ApiServiceMethodEnum(String value, String description) {
        this.value = value;
    ...
    public static ApiServiceMethodEnum resolve(String typeCode) {
        for (ApiServiceMethodEnum type : values()) {
