...
public enum RepositoryMethodEnum {
    ...
    private RepositoryMethodEnum(String value, String description) {
        this.value = value;
    ...
    public static RepositoryMethodEnum resolve(String typeCode) {
        for (RepositoryMethodEnum type : values()) {
