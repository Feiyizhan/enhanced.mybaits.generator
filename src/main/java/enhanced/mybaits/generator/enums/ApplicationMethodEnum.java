...
public enum ApplicationMethodEnum {
    ...
    private ApplicationMethodEnum(String value, String description) {
        this.value = value;
    ...
    public static ApplicationMethodEnum resolve(String typeCode) {
        for (ApplicationMethodEnum type : values()) {
