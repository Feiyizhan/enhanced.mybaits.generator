...
/**
 * Domain 接口实现类获取主键对应的记录方法生成器
 * @author 徐明龙 XuMingLong 
 */
public class DomainImplGetByPrimaryKeyMethodGenerator extends AbstractDomainImplMethodGenerator {

    public DomainImplGetByPrimaryKeyMethodGenerator(MixedContext mixedContext) {
        super(mixedContext);
    }
