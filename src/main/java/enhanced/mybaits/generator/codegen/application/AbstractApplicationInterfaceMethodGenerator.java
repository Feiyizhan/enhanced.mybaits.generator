...
/**
 * Application 接口方法生成器基类
 * @author 徐明龙 XuMingLong 
 */
public abstract class AbstractApplicationInterfaceMethodGenerator extends AbstractMethodGenerator {
    /**
     * dTO 变量名称后缀
     * @author 徐明龙 XuMingLong
     */
    ...
    public AbstractApplicationInterfaceMethodGenerator(MixedContext mixedContext) {
        super(mixedContext);
    ...
    public void addMethod() {
        ...
        if(commentGenerator instanceof IEnhanceCommentGenerator) {
            ...
            enhanceCommentGenerator.addApplicationMethodComment(method,getApplicationMethod());
        }
        mixedContext.getApplicationInterface().addMethod(method);
     ...
     * @return 返回方法对应的枚举
     */
    protected abstract ApplicationMethodEnum getApplicationMethod() ;
